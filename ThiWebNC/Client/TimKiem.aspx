<%@ Page Title="" Language="C#" MasterPageFile="~/Client/SiteClient.Master" AutoEventWireup="true" CodeBehind="TimKiem.aspx.cs" Inherits="ThiWebNC.Client.TimKiem" %>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 content-side">
                        <asp:Repeater runat="server" ID="rpTimkiem">
                            <ItemTemplate>
                                <div class="list-block main-block t-list-block">
                                    <div class="list-content">
                                        <div class="main-img list-img t-list-img">
                                            <a href="<%# "ChiTietTour.aspx?ID=" + Eval("Matour").ToString() %>&ml=<%# Eval("MaLoaiTour").ToString() %>&ttt=<%# Eval("MaTinhTrangTour").ToString() %>>&ttt=<%# Eval("MaTinhTrangTour").ToString() %>">
                                        ...
                                        <div class="list-info t-list-info">
                                            ...
                                            <a href="<%# "ChiTietTour.aspx?ID=" + Eval("Matour").ToString() %>&ml=<%# Eval("MaLoaiTour").ToString() %>&ttt=<%# Eval("MaTinhTrangTour").ToString() %>" class="btn btn-orange btn-lg">Xem Chi Tiết</a>
                                        </div>
                                        <!-- end t-list-info -->
                                    </div>
                                    <!-- end list-content -->
